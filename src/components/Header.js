    ...
    return (
        ...
        <div className="flex w-[50%]">
          <Link className="flex items-center" to="/">
            ...
            <div className="ml-[10px]">
              <span className="font-sans text-[20px] font-[700] text-[#fff]">Tskr</span>
              <span className="font-sans text-[20px] font-[700] text-[#5BBB7B]">.com</span>
            </div>
          </Link>
        </div>
        {/* Nav items */}
        <div className="flex justify-end w-[50%]">
          <div className="flex gap-[20px]">
            <Link className="font-sans text-[14px] font-[700] leading-[28px] text-[#fff] hover:text-[#5BBB7B] pt-[4px] pb-[4px] pl-[15px] pr-[15px]" to="/login">Messages</Link>
            <Link className="font-sans text-[14px] font-[700] leading-[28px] text-[#fff] hover:text-[#5BBB7B] pt-[4px] pb-[4px] pl-[15px] pr-[15px]" to="/register">Available Porjects</Link>
          </div>
          ...
          <div className="flex justify-end gap-[20px]">
            ...
            <Link className="font-sans text-[14px] font-[700] leading-[28px] text-[#fff] hover:text-[#5BBB7B] pt-[4px] pb-[4px] pl-[15px] pr-[15px]" to="/">Login</Link>
            <Link className="font-sans text-[14px] font-[700] leading-[28px] text-[#222] hover:text-[#FFF] hover:bg-[#5BBB7B] pt-[4px] pb-[4px] pl-[20px] pr-[20px] bg-[#FFF] rounded-[4px]" to="/register">Sign Up</Link>
          </div>
        </div>
      </div>
    )
